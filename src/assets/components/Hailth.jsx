...
export default function Hailth() {
    ...
    async function fetchHealthNews() {
      try {
        const res = await fetch(
          `https://newsapi.org/v2/top-headlines?category=Health&country=us&apiKey=aa754d4982324255903c14860f2150b4`
        );
  ...
  return (
    ...
    <div className="px-4 sm:px-8 md:px12 lg:px-[100px]  min-h-screen text-blue py-10 dark:bg-gray-900">
      {articles.length === 0 ? (
        <p className="text-center text-blue-400">No Health News Available.</p>
      ) : (
